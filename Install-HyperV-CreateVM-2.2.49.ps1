...
.NOTES/REFERENCES
  ...
  4.13.2026 - Update information syntax. v2.2.49
...
Write-Host "OOBE. A script has been create to assist with injecting drivers into the Windows" -ForegroundColor Yellow
