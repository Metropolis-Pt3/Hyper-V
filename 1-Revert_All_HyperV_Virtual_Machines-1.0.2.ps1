...
.DESCRIPTION
    To be used with a scheduled task nightly to revert VM's for consistent testing while keeping the VM's up to date.
    This script is #1 in the series (3 scripts in total). It should obe the first script to run to ensure consistant results.
