...
.PARAMETERS
  ...
  EXAMPLE
    .\Install-HyperV-CreateVM-2.2.54.ps1 -Name <Name> -CPUCount <1-6> -HyperV -IncludeGuiTools -NoRestart

    .\Install-HyperV-CreateVM-2.2.54.ps1 -Name <Name> -CPUCount <1-6> -Autopilot -ProductKey
...
function Get-TempIso {
    $iso = Get-ChildItem "C:\Temp" -Filter "*.iso" -ErrorAction SilentlyContinue |
