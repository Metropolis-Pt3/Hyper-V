...
.PARAMETERS
    ...
    EXAMPLES
        ...
        .\HyperV-Feature-On-Demand-1.0.2.ps1 -Gui = Installs Hyper-V Feature On-Demand Hypervisor and management tools, no reboot.

        .\HyperV-Feature-On-Demand-1.0.2.ps1 -Gui -Reboot = Installs Hyper-V Feature On-Demand Hypervisor and management tools, then forces reboot.
