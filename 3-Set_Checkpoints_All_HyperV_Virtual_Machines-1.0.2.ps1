...
.DESCRIPTION
    To be used with a scheduled task nightly to dset new/refesh VM checkpoints for consistent testing while keeping the VM's up to date.
    This script is #3 in the series (3 scripts in total) and should only run after 2-Delete_Checkpoints_All_HyperV_Virtual_Machines-1.0.2.ps1 has completed successfully.
...
.NOTES/REFERENCES
    ...
    Changelog
    4.2.2026 - Initial script created. v1.0.2
