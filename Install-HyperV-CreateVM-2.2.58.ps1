...
.SUMMARY
  ...
  ***Important***
  1. Its recommended to download and/or create a ISO servicing environment for hyper-v Windows installation.
     Iso servicing script is available: https://github.com/Metropolis-Pt3/MediaServicing
      
     This script will create the Hyper-V VM and auto attach the iso, if the iso exists
...
.PARAMETERS
  ...
  EXAMPLE
    .\Install-HyperV-CreateVM-2.2.58.ps1 -Name <Name> -CPUCount <1-6> -HyperV -IncludeGuiTools -NoRestart

    .\Install-HyperV-CreateVM-2.2.58.ps1 -Name <Name> -CPUCount <1-6> -Autopilot -ProductKey

.NOTES/REFERENCES
  Current Version=2.2.58
  Date: 3.6.2026
  Author: Steve Molzahn
  Inspired by: GetRubix - https://github.com/stevecapacity
  ...
  3.6.2026
     ...
     - Added useage parameters. v2.1.1
  ...
  4.28.2026
     - Updated usage parameters. v2.2.52
     - Added logic to detect Wndows 11 iso exist. If not, then download. v2.2.54

  4.30.2026 - Updated some logic and functions.  v2.2.56
  5.16.2026 - Added documentation and other things. v2.2.58
...
<# Not use due to required manual input. Leaving here for development purposes.
if($PowerOn -eq $True)
{
...
Write-Host "https://github.com/Metropolis-Pt3/MediaServicing" -ForegroundColor Cyan
Write-Host ""
Write-Host "------------------------------------------------------------------------------"
Write-Host ""
...
Write-Host ""
Write-Host "Get the powershell script here:" -ForegroundColor Cyan
Write-Host "https://github.com/Metropolis-Pt3/Autopilot" -ForegroundColor Cyan
Write-Host ""
Write-Host "------------------------------------------------------------------------------"
Write-Host ""
