...
.DESCRIPTION
    To be used with a scheduled task nightly to delete VM checkpoints for consistent testing while keeping the VM's up to date.
    This script is #2 in the series (3 scripts in total) and should only run after 1-Revert_All_HyperV_Virtual_Machines-1.0.2.ps1 has completed successfully.
